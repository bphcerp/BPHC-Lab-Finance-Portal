                    ...
                    <form onSubmit={onSubmit}>
                        <div className="space-y-4">
                            ...
                            <TextInput
                                ...
                                title={reimbursement.paidStatus ? "Reimbursement marked as paid, cant edit title." : ""}
                            />
                            <TextInput
                                value={description}
                            ...
                            {selectedProjectHead && (
                                <div>
                                    {selectedProjectHead !== reimbursement.projectHead && !projects.find((p) => p._id === selectedProject)?.negative_heads.includes(selectedProjectHead) &&
                        ...
                        <div className='flex mt-5 space-x-5'>
                            ...
                            <Button type="submit" color="blue" disabled={selectedProject && selectedProjectHead && selectedProjectHead !== reimbursement.projectHead && !projects.find((p) => p._id === selectedProject)?.negative_heads.includes(selectedProjectHead) &&
                                    (projects.find((p) => p._id === selectedProject)!.project_heads[selectedProjectHead][0] <
