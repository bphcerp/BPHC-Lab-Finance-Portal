    ...
    >
      <nav className="flex flex-col flex-grow mt-4" onClick={handleLinkClick}>
        ...
        <div className="w-full max-w-sm mx-auto">
          <button
            onClick={() =>
              setMenuState({ account: !menuState.account, pdAccount: false })
            }
            className={`flex items-center px-7 py-3 w-full hover:bg-gray-200 ${
              menuState.account ? "bg-gray-200" : ""
          ...
          <div
            className={`flex justify-center bg-gray-200 overflow-hidden transition-all duration-300 ease-in-out ${
              menuState.account ? "h-32" : "h-0"
            }`}
          >
        ...
        <div className="w-full max-w-sm mx-auto">
          <button
            onClick={() =>
              setMenuState({ account: false, pdAccount: !menuState.pdAccount })
            }
            className={`flex items-center px-7 py-3 w-full hover:bg-gray-200 ${
              menuState.pdAccount ? "bg-gray-200" : ""
            } transition-colors duration-200 ease-in-out`}
          >
